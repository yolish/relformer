...
from models.transformer.TransformerEncoder import TransformerEncoderLayer, _TransformerEncoder,_get_clones, _get_activation_fn
...
class Transformer(nn.Module):
    ...
    def forward(self, src, tgt, src_pos_embed, tgt_pos_embed):
        memory = self.encoder(src, src_key_padding_mask=None, pos=src_pos_embed)
        hs = self.decoder(tgt, memory, memory_key_padding_mask=None,
                          pos=src_pos_embed, query_pos=tgt_pos_embed)
        return hs
